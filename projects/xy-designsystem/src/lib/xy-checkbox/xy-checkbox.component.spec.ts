...
describe('XyCheckboxComponent', () => {
  let component: XyCheckboxComponent;
  let fixture: ComponentFixture<XyCheckboxComponent>;

  beforeEach(async () => {
    await TestBed.configureTestingModule({
      declarations: [ XyCheckboxComponent ],
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(XyCheckboxComponent);
  ...
  it('should color accent', () => {
    ...
    fixture.detectChanges();
    let button = fixture.debugElement.nativeElement.querySelector('.mat-checkbox');
  ...
  it('should disable', fakeAsync(() => {
    ...
    fixture.detectChanges();
    let input = fixture.debugElement.query(By.css('.mat-checkbox-input'));
